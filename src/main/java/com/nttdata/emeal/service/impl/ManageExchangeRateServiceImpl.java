...
public class ManageExchangeRateServiceImpl implements ManageExchangeRateService {
  ...
  private static final ManageExchangeRateMapper mapper = ManageExchangeRateMapper.INSTANCE;
     ...
     */
  @Override
  public ManageExchangeRateResponse saveRequestExchangeRate(ManageExchangeRateRequest request) {

    try {
      String dni = request.getConsultantUser().getDni();
      limitExceededValidation(dni);
  ...
  public ExchangeRateCountResponse getRequestCountByDni(String dni) {
    ...
    log.info("Getting fetch count for DNI: {}", dni);
  ...
  @Override
  public ManageExchangeRateRequest fetchCurrentExchangeRate(String dni) {

    limitExceededValidation(dni);
    ExchangeRateResponse exchangeRateResponse = exchangeRateApiService.getCurrentExchangeRate();
    ConsultantUser consultantUser = ConsultantUser.builder()
        .dni(dni)
        .build();

    return ManageExchangeRateRequest.builder()
  ...
  private long requestCountByDni(String dni) {
    ...
    log.info("Counting fetches for consultant DNI: {} ", dni);
    dniValidation(dni);
  ...
  private void limitExceededValidation(String dni) {
    dniValidation(dni);
